...
public class Books extends DataViewController<Book> {
    ...
    protected void registerSpotlightFields(SpotlightManager manager) {
        manager.registerSpotlight(identifier, "Book Identifier", "The selected book's identifier. It is autogenerated and cannot be changed.");
        manager.registerSpotlight(author, "Author's Name", "The name of the selected book's author.");
        manager.registerSpotlight(bookName, "Book Title", "The title of the selected book.");
        manager.registerSpotlight(isbn, "ISBN", "The ISBN of the selected book. Must be a valid 10 or 13 digit ISBN.");
        manager.registerSpotlight(status, "Status", "The current status of the selected book. Possible values include Available, Checked out, and Lost.");
        manager.registerSpotlight(currentPatron, "Current Patron", "The patron currently holding the selected book. " +
