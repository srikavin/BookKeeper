...
public class Transactions extends DataViewController<Transaction> {
    ...
    protected void registerSpotlightFields(SpotlightManager manager) {
        manager.registerSpotlight(identifier, "Transaction Identifer", "The selected Transactions's " +
                "identifier. It is autogenerated and cannot be changed.");
        ...
        manager.registerSpotlight(timestamp, "Timestamp", "The time that the transaction occurred. " +
                "It is in the format DD-MM-YY HH:MM AM/PM.");
    }
